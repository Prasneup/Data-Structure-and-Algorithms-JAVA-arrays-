...
public class MultiplicationOfTwoMatrices {
    ...
    static void mulOfTwoMatrices(int[][] a, int r1, int c1, int[][] b, int r2, int c2){
        if(c1 != r2){
            System.out.println("Multiplication not posssible - Invalid dimension");
            return;
        }
    ...
    public static void main(String[]args){
        ...
        mulOfTwoMatrices(a,r1,c1,b,r2,c2);
    }
}
